...
/* End Function:__RME_A6M_Fault_Handler **************************************/

/* Begin Function:__RME_A6M_Set_Flag ******************************************
...
Return      : None.
******************************************************************************/
void __RME_A6M_Set_Flag(rme_ptr_t Base,
                        rme_ptr_t Size,
                        rme_ptr_t Pos)
{
...
/* End Function:__RME_A6M_Set_Flag *******************************************/
...
void __RME_A6M_Vct_Handler(volatile struct RME_Reg_Struct* Reg, rme_ptr_t Vct_Num)
{
    ...
    __RME_A6M_Set_Flag(RME_RVM_PHYS_VCTF_BASE, RME_RVM_PHYS_VCTF_SIZE, Vct_Num);
...
/* Begin Function:__RME_A6M_Low_Level_Preinit *********************************
...
#endif
void __RME_A6M_Low_Level_Preinit(void)
{
    RME_A6M_LOW_LEVEL_PREINIT();
    
#if(RME_RVM_GEN_ENABLE==1U)
    RME_Boot_Pre_Init();
#endif
}
/* End Function:__RME_A6M_Low_Level_Preinit **********************************/
                                 ...
                                 rme_ptr_t Prio)
{
    ...
    RME_A6M_SCB_SHPR((((rme_ptr_t)Exc)&0x0FU)-4U)=(rme_u8_t)Prio;
}
...
rme_ptr_t __RME_Low_Level_Init(void)
{
    ...
    Temp=RME_A6M_SCB_AIRCR;
    Temp&=~0xFFFF0700U;
    Temp|=(0x5FAU<<16)|(RME_A6M_NVIC_GROUPING<<8);
    RME_A6M_SCB_AIRCR=Temp;
...
rme_ptr_t __RME_Boot(void)
{
    ...
    RME_ASSERT(_RME_Pgt_Boot_Add(RME_A6M_CPT, RME_BOOT_PGT, 0x40000000U, 2U, RME_PGT_ALL_PERM)==0);
    RME_ASSERT(_RME_Pgt_Boot_Add(RME_A6M_CPT, RME_BOOT_PGT, 0x60000000U, 3U, RME_PGT_ALL_PERM)==0);
    RME_ASSERT(_RME_Pgt_Boot_Add(RME_A6M_CPT, RME_BOOT_PGT, 0x80000000U, 4U, RME_PGT_ALL_PERM)==0);
    RME_ASSERT(_RME_Pgt_Boot_Add(RME_A6M_CPT, RME_BOOT_PGT, 0xA0000000U, 5U, RME_PGT_ALL_PERM)==0);
    RME_ASSERT(_RME_Pgt_Boot_Add(RME_A6M_CPT, RME_BOOT_PGT, 0xC0000000U, 6U, RME_PGT_ALL_PERM)==0);
    RME_ASSERT(_RME_Pgt_Boot_Add(RME_A6M_CPT, RME_BOOT_PGT, 0xE0000000U, 7U, RME_PGT_ALL_PERM)==0);
#endif

    /* Activate the first process - This process cannot be deleted */
    RME_ASSERT(_RME_Prc_Boot_Crt(RME_A6M_CPT, RME_BOOT_CPT, RME_BOOT_INIT_PRC, 
                                 RME_BOOT_CPT, RME_BOOT_PGT)==0U);
    
    /* Create the initial kernel function capability, and kernel memory capability */
    RME_ASSERT(_RME_Kfn_Boot_Crt(RME_A6M_CPT, RME_BOOT_CPT, RME_BOOT_INIT_KFN)==0);
    ...
    RME_A6M_Local.Sig_Tim=(struct RME_Cap_Sig*)&(RME_A6M_CPT[RME_BOOT_INIT_TIM]);
    RME_ASSERT(_RME_Sig_Boot_Crt(RME_A6M_CPT, RME_BOOT_CPT, RME_BOOT_INIT_TIM)==0);
    ...
    RME_ASSERT(_RME_Sig_Boot_Crt(RME_A6M_CPT, RME_BOOT_CPT, RME_BOOT_INIT_VCT)==0);
