/******************************************************************************
Filename    : rme_platform_rv32gp.c
Author      : pry
Date        : 01/04/2017
Licence     : The Unlicense; see LICENSE for details.
Description : The hardware abstraction layer for RV32GP PMP-based microcontrollers.
...
/* Includes ******************************************************************/
#define __HDR_DEFS__
#include "Platform/RV32GP/rme_platform_rv32gp.h"
...
/* Begin Function:__RME_RV32GP_Wait_Int ***************************************
Description : Wait until a new interrupt comes, to save power.
Input       : None.
Output      : None.
Return      : None.
******************************************************************************/
void __RME_RV32GP_Wait_Int(void)
{
    /* Calling functions implemented by risc-v library */
    RME_RV32GP_WAIT_INT();
}
/* End Function:__RME_RV32GP_Wait_Int ****************************************/

/* Begin Function:__RME_RV32GP_Exc_Handler ************************************
...
Return      : None.
******************************************************************************/
void __RME_RV32GP_Exc_Handler(struct RME_Reg_Struct* Reg, rme_ptr_t Mcause)
{
    /* Don't handle error, just quit for now */
    _RME_Thd_Fatal(Reg);
}
/* End Function:__RME_RV32GP_Exc_Handler *************************************/

/* Begin Function:__RME_RV32GP_Flag_Fast **************************************
...
Return      : None.
******************************************************************************/
void __RME_RV32GP_Flag_Fast(rme_ptr_t Base,
                            rme_ptr_t Size,
                            rme_ptr_t Flag)
{
...
/* End Function:__RME_RV32GP_Flag_Fast ***************************************/

/* Begin Function:__RME_RV32GP_Flag_Slow **************************************
...
Return      : None.
******************************************************************************/
void __RME_RV32GP_Flag_Slow(rme_ptr_t Base,
                            rme_ptr_t Size,
                            rme_ptr_t Pos)
{
    volatile struct __RME_RVM_Flag* Set;
...
/* End Function:__RME_RV32GP_Flag_Slow ***************************************/

/* Begin Function:_RME_RV32GP_Handler *****************************************
Description : The generic interrupt handler of RME for RV32GP, in C.
Input       : struct RME_Reg_Struct* Reg - The register set.
Output      : struct RME_Reg_Struct* Reg - The updated register set.
Return      : None.
******************************************************************************/
void _RME_RV32GP_Handler(struct RME_Reg_Struct* Reg)
{
    rme_ptr_t Mcause;

    Mcause=__RME_RV32GP_MCAUSE_Get();

    /* Turn to appropriate handlers */
    if(Mcause==(RME_RV32GP_MCAUSE_TIM|0x80000000U))
    {
        RME_RV32GP_Timestamp++;

#if(RME_RVM_GEN_ENABLE==1U)
    __RME_RV32GP_Flag_Fast(RME_RVM_PHYS_VCTF_BASE, RME_RVM_PHYS_VCTF_SIZE, 1U);
#endif
    ...
    else if((Mcause&0x80000000U)!=0U)
    {
        ...
        __RME_RV32GP_Flag_Slow(RME_RVM_PHYS_VCTF_BASE, RME_RVM_PHYS_VCTF_SIZE, Mcause);

        _RME_Kern_Snd(RME_RV32GP_Local.Sig_Vct);
        /* Remember to pick the guy with the highest priority after we did all sends */
        _RME_Kern_High(Reg, &RME_RV32GP_Local);
    }
    else if(Mcause==RME_RV32GP_MCAUSE_U_ECALL)
        _RME_Svc_Handler(Reg);
    else
        __RME_RV32GP_Exc_Handler(Reg, Mcause);
    ...
    RME_RV32GP_MSTATUS_FIX(Reg);
}
/* End Function:_RME_RV32GP_Handler ******************************************/

/* Begin Function:__RME_RV32GP_Pgt_Entry_Mod **********************************
Description : Consult or modify the page table attributes. RV32GP only allows
...
******************************************************************************/
rme_ret_t __RME_RV32GP_Pgt_Entry_Mod(struct RME_Cap_Cpt* Cpt,
                                  rme_cid_t Cap_Pgt,
                                  rme_ptr_t Vaddr,
                                  rme_ptr_t Type)
{
    ...
    switch(Type)
    {
        case RME_RV32GP_KFN_PGT_ENTRY_MOD_GET_FLAGS: return (rme_ret_t)Flags;
        case RME_RV32GP_KFN_PGT_ENTRY_MOD_GET_SIZEORDER: return (rme_ret_t)Size_Order;
        case RME_RV32GP_KFN_PGT_ENTRY_MOD_GET_NUMORDER: return (rme_ret_t)Num_Order;
        default:break;
    }
    
    return RME_ERR_KFN_FAIL;
}
/* End Function:__RME_RV32GP_Pgt_Entry_Mod ***********************************/

/* Begin Function:__RME_RV32GP_Int_Local_Mod **********************************
...
******************************************************************************/
rme_ret_t __RME_RV32GP_Int_Local_Mod(rme_ptr_t Int_Num,
                                     rme_ptr_t Operation,
                                     rme_ptr_t Param)
{
    ...
    switch(Operation)
    {
        case RME_RV32GP_KFN_INT_LOCAL_MOD_GET_STATE:
        {
            RME_RV32GP_INT_GET_STATE(Int_Num);
            break;
        }
        case RME_RV32GP_KFN_INT_LOCAL_MOD_SET_STATE:
        {
            if(Param==0U)
                RME_RV32GP_INT_SET_DISABLE(Int_Num);
            else
                RME_RV32GP_INT_SET_ENABLE(Int_Num);
            break;
        }
        case RME_RV32GP_KFN_INT_LOCAL_MOD_GET_PRIO:
        {
            RME_RV32GP_INT_GET_PRIO(Int_Num);
            break;
        }
        case RME_RV32GP_KFN_INT_LOCAL_MOD_SET_PRIO:
        {
            RME_RV32GP_INT_SET_PRIO(Int_Num, Param);
            break;
        }
        default:RME_ERR_KFN_FAIL;
    }
    
    return 0;
}
/* End Function:__RME_RV32GP_Int_Local_Mod ***********************************/

/* Begin Function:__RME_RV32GP_Int_Local_Trig *********************************
...
******************************************************************************/
rme_ret_t __RME_RV32GP_Int_Local_Trig(rme_ptr_t CPUID,
                                      rme_ptr_t Int_Num)
{
    if(Int_Num>=RME_RVM_PHYS_VCT_NUM)
        return RME_ERR_KFN_FAIL;
    ...
    RME_RV32GP_INT_LOCAL_TRIG(Int_Num);

    return 0;
}
/* End Function:__RME_RV32GP_Int_Local_Trig **********************************/

/* Begin Function:__RME_RV32GP_Evt_Local_Trig *********************************
Description : Trigger a CPU's local event source.
Input       : struct RME_Reg_Struct* Reg - The register set.
...
Return      : rme_ret_t - If successful, 0; else RME_ERR_KFN_FAIL.
******************************************************************************/
rme_ret_t __RME_RV32GP_Evt_Local_Trig(struct RME_Reg_Struct* Reg,
                                      rme_ptr_t CPUID,
                                      rme_ptr_t Evt_Num)
{
    ...
    __RME_RV32GP_Flag_Slow(RME_RVM_VIRT_EVTF_BASE, RME_RVM_VIRT_EVTF_SIZE, Evt_Num);
    
    if(_RME_Kern_Snd(RME_RV32GP_Local.Sig_Vct)!=0U)
        return RME_ERR_KFN_FAIL;
...
/* End Function:__RME_RV32GP_Evt_Local_Trig **********************************/

/* Begin Function:__RME_RV32GP_Cache_Mod **************************************
...
******************************************************************************/
rme_ret_t __RME_RV32GP_Cache_Mod(rme_ptr_t Cache_ID,
                                 rme_ptr_t Operation,
                                 rme_ptr_t Param)
{
    RME_RV32GP_CACHE_MOD(Cache_ID, Operation, Param);

    return 0;
}
/* End Function:__RME_RV32GP_Cache_Mod ***************************************/

/* Begin Function:__RME_RV32GP_Cache_Maint ************************************
...
Return      : If successful, 0; else RME_ERR_KFN_FAIL.
******************************************************************************/
rme_ret_t __RME_RV32GP_Cache_Maint(rme_ptr_t Cache_ID,
                                   rme_ptr_t Operation,
                                   rme_ptr_t Param)
{
    RME_RV32GP_CACHE_MAINT(Cache_ID, Operation, Param);

    return 0;
}
/* End Function:__RME_RV32GP_Cache_Maint *************************************/

/* Begin Function:__RME_RV32GP_Prfth_Mod **************************************
...
Return      : If successful, 0; else RME_ERR_KFN_FAIL.
******************************************************************************/
rme_ret_t __RME_RV32GP_Prfth_Mod(rme_ptr_t Prfth_ID,
                                 rme_ptr_t Operation,
                                 rme_ptr_t Param)
{
    RME_RV32GP_PRFTH_MOD(Prfth_ID, Operation, Param);

    return  0;
}
/* End Function:__RME_RV32GP_Prfth_Mod ***************************************/

/* Begin Function:__RME_RV32GP_Perf_CPU_Func **********************************
Description : CPU feature detection for RV32GP.
Input       : struct RME_Reg_Struct* Reg - The register set.
              rme_ptr_t Freg_ID - The capability to the thread to consult.
Output      : struct RME_Reg_Struct* Reg - The updated register set.
Return      : rme_ret_t - If successful, 0; if a negative value, failed.
******************************************************************************/
rme_ret_t __RME_RV32GP_Perf_CPU_Func(struct RME_Reg_Struct* Reg,
                                     rme_ptr_t Freg_ID)
{
    /* Read dedicated feature register, but musk out bit width - we already know */
    return __RME_RV32GP_MISA_Get()&0x3FFFFFFFU;
}
/* End Function:__RME_RV32GP_Perf_CPU_Func ***********************************/

/* Begin Function:__RME_RV32GP_Perf_Mon_Mod ***********************************
...
******************************************************************************/
rme_ret_t __RME_RV32GP_Perf_Mon_Mod(rme_ptr_t Perf_ID,
                                    rme_ptr_t Operation,
                                    rme_ptr_t Param)
{
    RME_RV32GP_PERF_MON_MOD(Perf_ID, Operation, Param);

    return 0;
}
/* End Function:__RME_RV32GP_Perf_Mon_Mod ************************************/

/* Begin Function:__RME_RV32GP_Perf_Cycle_Mod *********************************
...
Return      : rme_ret_t - If successful, 0; if a negative value, failed.
******************************************************************************/
rme_ret_t __RME_RV32GP_Perf_Cycle_Mod(struct RME_Reg_Struct* Reg,
                                      rme_ptr_t Cycle_ID,
                                      rme_ptr_t Operation,
                                      rme_ptr_t Value)
{
    RME_RV32GP_PERF_CYCLE_MOD(Cycle_ID, Operation, Value);

    return 0;
}
/* End Function:__RME_RV32GP_Perf_Cycle_Mod **********************************/

/* Begin Function:__RME_RV32GP_Debug_Reg_Mod **********************************
Description : Debug regular register modification implementation for RV32GP.
Input       : struct RME_Cap_Cpt* Cpt - The current capability table.
...
Return      : rme_ret_t - If successful, 0; if a negative value, failed.
******************************************************************************/
rme_ret_t __RME_RV32GP_Debug_Reg_Mod(struct RME_Cap_Cpt* Cpt,
                                     ...
                                     rme_ptr_t Value)
{
    ...
    Register=Operation&(~RME_RV32GP_KFN_DEBUG_REG_MOD_SET);
    if(Register<=RME_RV32GP_KFN_DEBUG_REG_MOD_X31_T6)
        Position=&(((volatile rme_ptr_t*)&(Thd_Struct->Ctx.Reg->Reg))[Register]);
    /* See if this thread have FPU context. */
#if(RME_COP_NUM!=0U)
    else if((RME_THD_ATTR(Thd_Struct->Ctx.Hyp_Attr)!=0U)&&(Register<=RME_RV32GP_KFN_DEBUG_REG_MOD_F31))
    /* Double-precision FPU */
#if(RME_RV32GP_COP_RVD!=0U)
    {
        if(Register==RME_RV32GP_KFN_DEBUG_REG_MOD_FCSR)
            Position=&(((volatile rme_ptr_t*)&(Thd_Struct->Ctx.Reg->Cop))[0]);
        else
            Position=&(((volatile rme_ptr_t*)&(Thd_Struct->Ctx.Reg->Cop))[(Register-RME_RV32GP_KFN_DEBUG_REG_MOD_FCSR)*2U-1U]);
    }
    /* Single-precision FPU */
#else
        Position=&(((volatile rme_ptr_t*)&(Thd_Struct->Ctx.Reg->Cop))[Register-RME_RV32GP_KFN_DEBUG_REG_MOD_FCSR]);
#endif
#endif
    else
        return RME_ERR_KFN_FAIL;
    ...
    /* Perform read/write */
    if((Operation&RME_RV32GP_KFN_DEBUG_REG_MOD_SET)==0U)
    {
        Reg->X11_A1=Position[0];
#if((RME_COP_NUM!=0U)&&(RME_RV32GP_COP_RVD!=0U))
        if(Register>=RME_RV32GP_KFN_DEBUG_REG_MOD_F0)
...
/* End Function:__RME_RV32GP_Debug_Reg_Mod ***********************************/

/* Begin Function:__RME_RV32GP_Debug_Inv_Mod **********************************
Description : Debug invocation register modification implementation for RV32GP.
Input       : struct RME_Cap_Cpt* Cpt - The current capability table.
              struct RME_Reg_Struct* Reg - The current register set.
              rme_cid_t Cap_Thd - The capability to the thread to consult.
              rme_ptr_t Operation - The operation, e.g. which register to read or write.
...
Return      : rme_ret_t - If successful, 0; if a negative value, failed.
******************************************************************************/
rme_ret_t __RME_RV32GP_Debug_Inv_Mod(struct RME_Cap_Cpt* Cpt,
                                     struct RME_Reg_Struct* Reg,
                                     rme_cid_t Cap_Thd,
                                     rme_ptr_t Operation,
                                     rme_ptr_t Value)
{
    ...
    {
        /* Register read/write */
        case RME_RV32GP_KFN_DEBUG_INV_MOD_SP_GET:   {Reg->X11_A1=Inv_Struct->Ret.X2_SP;break;}
        case RME_RV32GP_KFN_DEBUG_INV_MOD_SP_SET:   {Inv_Struct->Ret.X2_SP=Value;break;}
        case RME_RV32GP_KFN_DEBUG_INV_MOD_PC_GET:   {Reg->X11_A1=Inv_Struct->Ret.PC;break;}
        case RME_RV32GP_KFN_DEBUG_INV_MOD_PC_SET:   {Inv_Struct->Ret.PC=Reg->X11_A1;break;}
        default:                                    {return RME_ERR_KFN_FAIL;}
    }

    return 0;
}
/* End Function:__RME_RV32GP_Debug_Inv_Mod ***********************************/

/* Begin Function:__RME_RV32GP_Debug_Exc_Get **********************************
Description : Debug exception register extraction implementation for RV32GP.
Input       : struct RME_Cap_Cpt* Cpt - The current capability table.
              struct RME_Reg_Struct* Reg - The current register set.
              rme_cid_t Cap_Thd - The capability to the thread to consult.
...
Return      : rme_ret_t - If successful, 0; if a negative value, failed.
******************************************************************************/
rme_ret_t __RME_RV32GP_Debug_Exc_Get(struct RME_Cap_Cpt* Cpt,
                                     struct RME_Reg_Struct* Reg,
                                     rme_cid_t Cap_Thd,
                                     rme_ptr_t Operation)
{
    ...
    {
        /* Register read */
        case RME_RV32GP_KFN_DEBUG_EXC_CAUSE_GET:    {Reg->X12_A2=Thd_Struct->Ctx.Reg->Exc.Cause;break;}
        case RME_RV32GP_KFN_DEBUG_EXC_ADDR_GET:     {Reg->X12_A2=Thd_Struct->Ctx.Reg->Exc.Addr;break;}
        default:                                    {return RME_ERR_KFN_FAIL;}
    }

    return 0U;
}
/* End Function:__RME_RV32GP_Debug_Exc_Get ***********************************/
...
/* Page table operations *****************************************************/
        ...
        case RME_KFN_PGT_ENTRY_MOD:     {Retval=__RME_RV32GP_Pgt_Entry_Mod(Cpt, (rme_cid_t)Sub_ID, Param1, Param2);break;}
/* Interrupt controller operations *******************************************/
        case RME_KFN_INT_LOCAL_MOD:     {Retval=__RME_RV32GP_Int_Local_Mod(Sub_ID, Param1, Param2);break;}
        case RME_KFN_INT_GLOBAL_MOD:    {return RME_ERR_KFN_FAIL;}
        case RME_KFN_INT_LOCAL_TRIG:    {Retval=__RME_RV32GP_Int_Local_Trig(Sub_ID, Param1);break;} /* Never ctxsw */
        case RME_KFN_EVT_LOCAL_TRIG:    {return __RME_RV32GP_Evt_Local_Trig(Reg, Sub_ID, Param1);} /* May ctxsw */
/* Cache operations **********************************************************/
        case RME_KFN_CACHE_MOD:         {Retval=__RME_RV32GP_Cache_Mod(Sub_ID, Param1, Param2);break;}
        case RME_KFN_CACHE_CONFIG:      {return RME_ERR_KFN_FAIL;}
        case RME_KFN_CACHE_MAINT:       {Retval=__RME_RV32GP_Cache_Maint(Sub_ID, Param1, Param2);break;}
        case RME_KFN_CACHE_LOCK:        {return RME_ERR_KFN_FAIL;}
        case RME_KFN_PRFTH_MOD:         {Retval=__RME_RV32GP_Prfth_Mod(Sub_ID, Param1, Param2);break;}
...
/* Power and frequency adjustment operations *********************************/
        case RME_KFN_IDLE_SLEEP:        {__RME_RV32GP_Wait_Int();Retval=0;break;}
        case RME_KFN_SYS_REBOOT:        {__RME_RV32GP_Reboot();while(1);break;}
...
/* Performance monitoring operations *****************************************/
        case RME_KFN_PERF_CPU_FUNC:     {Retval=__RME_RV32GP_Perf_CPU_Func(Reg, Sub_ID);break;} /* Value in a3 */
        case RME_KFN_PERF_MON_MOD:      {Retval=__RME_RV32GP_Perf_Mon_Mod(Sub_ID, Param1, Param2);break;}
        case RME_KFN_PERF_CNT_MOD:      {return RME_ERR_KFN_FAIL;}
        case RME_KFN_PERF_CYCLE_MOD:    {Retval=__RME_RV32GP_Perf_Cycle_Mod(Reg, Sub_ID, Param1, Param2);break;} /* Value in a3 */
...
#endif
        case RME_KFN_DEBUG_REG_MOD:     {Retval=__RME_RV32GP_Debug_Reg_Mod(Cpt, Reg, (rme_cid_t)Sub_ID, Param1, Param2);break;} /* Value in R6 */
        case RME_KFN_DEBUG_INV_MOD:     {Retval=__RME_RV32GP_Debug_Inv_Mod(Cpt, Reg, (rme_cid_t)Sub_ID, Param1, Param2);break;} /* Value in R6 */
        case RME_KFN_DEBUG_EXC_GET:     {Retval=__RME_RV32GP_Debug_Exc_Get(Cpt, Reg, (rme_cid_t)Sub_ID, Param1);break;} /* Value in R6 */
...
/* Begin Function:__RME_RV32GP_Lowlvl_Preinit *********************************
...
Return      : None.
******************************************************************************/
void __RME_RV32GP_Lowlvl_Preinit(void)
{
    RME_RV32GP_LOWLVL_PREINIT();
    
#if(RME_RVM_GEN_ENABLE==1U)
    RME_Boot_Pre_Init();
#endif
}
/* End Function:__RME_RV32GP_Lowlvl_Preinit **********************************/
...
void __RME_Lowlvl_Init(void)
{
    ...
    RME_RV32GP_LOWLVL_INIT();

    /* Initialize CPU-local data structures */
    _RME_CPU_Local_Init(&RME_RV32GP_Local, __RME_CPUID_Get());
...
#if(RME_RV32GP_FPU_TYPE!=RME_RV32GP_FPU_NONE)
...
//    RME_ASSERT(_RME_Pgt_Boot_Crt(RME_RV32GP_CPT, RME_BOOT_INIT_CPT, RME_BOOT_INIT_PGT,
...
//    RME_ASSERT(_RME_Pgt_Boot_Add(RME_RV32GP_CPT, RME_BOOT_INIT_PGT, 0x00000000U, 0U, RME_PGT_ALL_PERM)==0);
//
//    /* Activate the first process - This process cannot be deleted */
//    RME_ASSERT(_RME_Prc_Boot_Crt(RME_RV32GP_CPT, RME_BOOT_INIT_CPT, RME_BOOT_INIT_PRC,
//                                 RME_BOOT_INIT_CPT, RME_BOOT_INIT_PGT)==0U);
//
//    /* Create the initial kernel function capability, and kernel memory capability */
//    RME_ASSERT(_RME_Kfn_Boot_Crt(RME_RV32GP_CPT, RME_BOOT_INIT_CPT, RME_BOOT_INIT_KFN)==0);
//    RME_ASSERT(_RME_Kom_Boot_Crt(RME_RV32GP_CPT,
//                                 RME_BOOT_INIT_CPT,
//                                 RME_BOOT_INIT_KOM,
//                                 RME_KOM_VA_BASE,
...
//    RME_RV32GP_Local.Sig_Tim=(struct RME_Cap_Sig*)&(RME_RV32GP_CPT[RME_BOOT_INIT_TIM]);
//    RME_ASSERT(_RME_Sig_Boot_Crt(RME_RV32GP_CPT, RME_BOOT_INIT_CPT, RME_BOOT_INIT_TIM)==0);
//
//    /* Create the initial kernel endpoint for all other interrupts */
//    RME_RV32GP_Local.Sig_Vct=(struct RME_Cap_Sig*)&(RME_RV32GP_CPT[RME_BOOT_INIT_VCT]);
//    RME_ASSERT(_RME_Sig_Boot_Crt(RME_RV32GP_CPT, RME_BOOT_INIT_CPT, RME_BOOT_INIT_VCT)==0);
//
...
//    RME_ASSERT(_RME_Thd_Boot_Crt(RME_RV32GP_CPT, RME_BOOT_INIT_CPT, RME_BOOT_INIT_THD,
//                                 RME_BOOT_INIT_PRC, Cur_Addr, 0U, &RME_RV32GP_Local)==0);
...
//#if(RME_RVM_GEN_ENABLE==1U)
//    Cur_Addr=RME_Boot_Vct_Init(RME_RV32GP_CPT, RME_BOOT_INIT_VCT+1U, Cur_Addr);
//#endif
//
...
//    __RME_Pgt_Set(RME_CAP_GETOBJ((RME_RV32GP_Local.Thd_Cur)->Sched.Prc->Pgt,rme_ptr_t));
//
//    RME_DBG_S("__RME_Int_Enable\r\n");
//
//    __RME_Int_Enable();
//
//    RME_DBG_S("22222\r\n");
...
//    __RME_User_Enter(Test_Init, RME_RV32GP_INIT_STACK, 0U);
}
/* End Function:__RME_Boot ***************************************************/

/* Begin Function:__RME_RV32GP_Reboot *****************************************
Description : Reboot the MCU, including all its peripherals.
Input       : None.
Output      : None.
Return      : None.
******************************************************************************/
void __RME_RV32GP_Reboot(void)
{
    /* Reboots the platform, which includes all peripherals. */
    RME_RV32GP_REBOOT();
}
/* End Function:__RME_RV32GP_Reboot ******************************************/
                        ...
                        struct RME_Reg_Struct* Reg)
{
    /* Decide FPU state */
#if(RME_COP_NUM==0U)
    Reg->MSTATUS=RME_RV32GP_MSTATUS_INIT;
#else
    if(Attr==RME_RV32GP_ATTR_NONE)
        Reg->MSTATUS=RME_RV32GP_MSTATUS_INIT;
    else
        Reg->MSTATUS=RME_RV32GP_MSTATUS_INIT|RME_RV32GP_MSTATUS_FPU_INIT;
#endif
    /* The entry point needs to have the last bit set to avoid RV32GP mode */
    Reg->PC=Entry;
...
{
    if(Attr!=RME_RV32GP_ATTR_NONE)
        return sizeof(struct RME_RV32GP_Cop_Struct);
...
void __RME_Thd_Cop_Init(rme_ptr_t Attr,
                        ...
                        void* Cop)
{
    struct RME_RV32GP_Cop_Struct* RV32GP_Cop;
    ...
    RV32GP_Cop->F31=0U;
#else
    RV32GP_Cop->F0[0]=0U, RV32GP_Cop->F0[1]=0U;
    RV32GP_Cop->F1[0]=0U, RV32GP_Cop->F1[1]=0U;
    RV32GP_Cop->F2[0]=0U, RV32GP_Cop->F2[1]=0U;
    RV32GP_Cop->F3[0]=0U, RV32GP_Cop->F3[1]=0U;
    RV32GP_Cop->F4[0]=0U, RV32GP_Cop->F4[1]=0U;
    RV32GP_Cop->F5[0]=0U, RV32GP_Cop->F5[1]=0U;
    RV32GP_Cop->F6[0]=0U, RV32GP_Cop->F6[1]=0U;
    RV32GP_Cop->F7[0]=0U, RV32GP_Cop->F7[1]=0U;
    RV32GP_Cop->F8[0]=0U, RV32GP_Cop->F8[1]=0U;
    RV32GP_Cop->F9[0]=0U, RV32GP_Cop->F9[1]=0U;
    RV32GP_Cop->F10[0]=0U, RV32GP_Cop->F10[1]=0U;
    RV32GP_Cop->F11[0]=0U, RV32GP_Cop->F11[1]=0U;
    RV32GP_Cop->F12[0]=0U, RV32GP_Cop->F12[1]=0U;
    RV32GP_Cop->F13[0]=0U, RV32GP_Cop->F13[1]=0U;
    RV32GP_Cop->F14[0]=0U, RV32GP_Cop->F14[1]=0U;
    RV32GP_Cop->F15[0]=0U, RV32GP_Cop->F15[1]=0U;
    RV32GP_Cop->F16[0]=0U, RV32GP_Cop->F16[1]=0U;
    RV32GP_Cop->F17[0]=0U, RV32GP_Cop->F17[1]=0U;
    RV32GP_Cop->F18[0]=0U, RV32GP_Cop->F18[1]=0U;
    RV32GP_Cop->F19[0]=0U, RV32GP_Cop->F19[1]=0U;
    RV32GP_Cop->F20[0]=0U, RV32GP_Cop->F20[1]=0U;
    RV32GP_Cop->F21[0]=0U, RV32GP_Cop->F21[1]=0U;
    RV32GP_Cop->F22[0]=0U, RV32GP_Cop->F22[1]=0U;
    RV32GP_Cop->F23[0]=0U, RV32GP_Cop->F23[1]=0U;
    RV32GP_Cop->F24[0]=0U, RV32GP_Cop->F24[1]=0U;
    RV32GP_Cop->F25[0]=0U, RV32GP_Cop->F25[1]=0U;
    RV32GP_Cop->F26[0]=0U, RV32GP_Cop->F26[1]=0U;
    RV32GP_Cop->F27[0]=0U, RV32GP_Cop->F27[1]=0U;
    RV32GP_Cop->F28[0]=0U, RV32GP_Cop->F28[1]=0U;
    RV32GP_Cop->F29[0]=0U, RV32GP_Cop->F29[1]=0U;
    RV32GP_Cop->F30[0]=0U, RV32GP_Cop->F30[1]=0U;
    RV32GP_Cop->F31[0]=0U, RV32GP_Cop->F31[1]=0U;
#endif
}
#endif
                        ...
                        void* Cop_Cur)
{
    ...
    if(Attr_Cur!=RME_RV32GP_ATTR_NONE)
    {
        if(((Reg_Cur->MSTATUS)&RME_RV32GP_MSTATUS_FPU_MASK)!=0U)
        {
            ...
            ___RME_RV32GP_Thd_Cop_Save(Cop_Cur);
            Dirty=1U;
        }
    }

    /* The next thread does have FPU capability */
    if(Attr_New!=RME_RV32GP_ATTR_NONE)
    {
        /* Enable FPU to prepare for FPU context operations. The final FPU
         * enabling status will be set on vector handler exit. */
        __RME_RV32GP_MSTATUS_Set(RME_RV32GP_MSTATUS_INIT|RME_RV32GP_MSTATUS_FPU_INIT);
        /* The next thread made use of that capability, need to load context */
        if(((Reg_New->MSTATUS)&RME_RV32GP_MSTATUS_FPU_MASK)!=0U)
        {
            ___RME_RV32GP_Thd_Cop_Load(Cop_New);
            Dirty=1U;
        }
...
Description : Initialize the kernel mapping tables, so it can be added to all the
              top-level page tables. In RV32GP, we do not need to add such pages.
Input       : None.
Output      : None.
...
/* Begin Function:__RME_RV32GP_Rand **********************************************
Description : The random number generator used for random replacement policy.
              RV32GP have only one core, thus we make the LFSR local.
Input       : None.
Output      : None.
Return      : rme_ptr_t - The random number returned.
******************************************************************************/
rme_ptr_t __RME_RV32GP_Rand(void)
{   
...
/* End Function:__RME_RV32GP_Rand ***********************************************/
...
rme_ret_t __RME_Pgt_Init(struct RME_Cap_Pgt* Pgt_Op)
{
    ...
    ((struct __RME_RV32GP_Pgt_Meta*)Ptr)->Base=Pgt_Op->Base;
    ((struct __RME_RV32GP_Pgt_Meta*)Ptr)->Size_Num_Order=Pgt_Op->Size_Num_Order;
    Ptr+=sizeof(struct __RME_RV32GP_Pgt_Meta)/sizeof(rme_ptr_t);

    /* Is this a top-level? If it is, we need to clean up the MPU data */
    if(((Pgt_Op->Base)&RME_PGT_TOP)!=0U)
    {
        ((struct __RME_RV32GP_PMP_Data*)Ptr)->Static=0U;
        for(Count=0U;Count<RME_RV32GP_PMPCFG_NUM;Count++)
            ((struct __RME_RV32GP_PMP_Data*)Ptr)->Cfg[Count]=0U;
        for(Count=0U;Count<RME_RV32GP_REGION_NUM;Count++)
            ((struct __RME_RV32GP_PMP_Data*)Ptr)->Addr[Count]=0U;

        Ptr+=sizeof(struct __RME_RV32GP_PMP_Data)/sizeof(rme_ptr_t);
    }
...
{
    struct __RME_RV32GP_PMP_Data* PMP_Data;

    PMP_Data=(struct __RME_RV32GP_PMP_Data*)(RME_CAP_GETOBJ(Pgt, rme_ptr_t)+
                                             sizeof(struct __RME_RV32GP_Pgt_Meta));
...
#if(RME_RV32GP_REGION_NUM==1U)
    ___RME_RV32GP_PMP_Set1(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==2U)
    ___RME_RV32GP_PMP_Set2(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==3U)
    ___RME_RV32GP_PMP_Set3(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==4U)
    ___RME_RV32GP_PMP_Set4(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==5U)
    ___RME_RV32GP_PMP_Set5(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==6U)
    ___RME_RV32GP_PMP_Set6(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==7U)
    ___RME_RV32GP_PMP_Set7(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==8U)
    ___RME_RV32GP_PMP_Set8(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==9U)
    ___RME_RV32GP_PMP_Set9(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==10U)
    ___RME_RV32GP_PMP_Set10(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==11U)
    ___RME_RV32GP_PMP_Set11(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==12U)
    ___RME_RV32GP_PMP_Set12(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==13U)
    ___RME_RV32GP_PMP_Set13(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==14U)
    ___RME_RV32GP_PMP_Set14(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==15U)
    ___RME_RV32GP_PMP_Set15(PMP_Data->Cfg, PMP_Data->Addr);
#elif(RME_RV32GP_REGION_NUM==16U)
    ___RME_RV32GP_PMP_Set16(PMP_Data->Cfg, PMP_Data->Addr);
#endif
}
                             ...
                             rme_ptr_t Flag)
{
    rme_u8_t* Flagtbl;
    rme_ptr_t* Table;
    struct __RME_RV32GP_Pgt_Meta* Meta;
    ...
    /* Get the metadata */
    Meta=RME_CAP_GETOBJ(Pgt_Op,struct __RME_RV32GP_Pgt_Meta*);

    /* Where is the entry slot */
    if(((Pgt_Op->Base)&RME_PGT_TOP)!=0U)
        Table=RME_RV32GP_PGT_TBL_TOP(Meta);
    else
        Table=RME_RV32GP_PGT_TBL_NOM(Meta);

    /* Check if we are trying to make duplicate mappings into the same location */
    if((Table[Pos]&RME_RV32GP_PGT_PRESENT)!=0U)
        return RME_ERR_HAL_FAIL;

    /* Register into the page table - PMP updated by page faults */
    Table[Pos]=RME_RV32GP_PGT_PRESENT|RME_RV32GP_PGT_TERMINAL|
                               ...
                               rme_ptr_t Pos)
{
    ...
    if(((Table[Pos]&RME_RV32GP_PGT_PRESENT)==0)||((Table[Pos]&RME_RV32GP_PGT_TERMINAL)==0U))
        return RME_ERR_HAL_FAIL;
                              ...
                              rme_ptr_t Flag)
{
    rme_u8_t* Flagtbl;
    rme_ptr_t* Table;
    struct __RME_RV32GP_Pgt_Meta* Parent_Meta;
    struct __RME_RV32GP_Pgt_Meta* Child_Meta;

    /* Get the metadata */
    Parent_Meta=RME_CAP_GETOBJ(Pgt_Parent,struct __RME_RV32GP_Pgt_Meta*);
    Child_Meta=RME_CAP_GETOBJ(Pgt_Child,struct __RME_RV32GP_Pgt_Meta*);
    ...
    if(((Parent_Meta->Base)&RME_PGT_TOP)!=0U)
        Table=RME_RV32GP_PGT_TBL_TOP(Parent_Meta);
    else
        Table=RME_RV32GP_PGT_TBL_NOM(Parent_Meta);
    ...
    /* Register into the page table - PMP updated by page faults */
    Table[Pos]=RME_RV32GP_PGT_PRESENT|RME_RV32GP_PGT_PGD_ADDR((rme_ptr_t)Child_Meta);
                                ...
                                struct RME_Cap_Pgt* Pgt_Child)
{
    ...
    if(((Table[Pos]&RME_RV32GP_PGT_PRESENT)==0U)||((Table[Pos]&RME_RV32GP_PGT_TERMINAL)!=0U))
        return RME_ERR_HAL_FAIL;

    /* See if the child page table is actually mapped there */
    Child_Meta=(struct __RME_RV32GP_Pgt_Meta*)RME_RV32GP_PGT_PGD_ADDR(Table[Pos]);
    if(Child_Meta!=RME_CAP_GETOBJ(Pgt_Child, struct __RME_RV32GP_Pgt_Meta*))
        return RME_ERR_HAL_FAIL;
                           ...
                           rme_ptr_t* Flag)
{
    ...
    if(((Pgt_Op->Base)&RME_PGT_TOP)!=0U)
        Table=RME_RV32GP_PGT_TBL_TOP(RME_CAP_GETOBJ(Pgt_Op,rme_ptr_t*));
    else
        Table=RME_RV32GP_PGT_TBL_NOM(RME_CAP_GETOBJ(Pgt_Op,rme_ptr_t*));

    /* Start lookup */
    if(((Table[Pos]&RME_RV32GP_PGT_PRESENT)==0U)||
       ((Table[Pos]&RME_RV32GP_PGT_TERMINAL)==0U))
        return RME_ERR_HAL_FAIL;

    /* This is a page. Return the physical address and flags */
    if(Paddr!=RME_NULL)
        *Paddr=RME_RV32GP_PGT_PTE_ADDR(Table[Pos]);
                         ...
                         rme_ptr_t* Flag)
{
    ...
    while(1)
    {
        ...
        if(Vaddr<RME_RV32GP_PGT_START(Meta->Base))
            return RME_ERR_HAL_FAIL;
        /* Calculate where is the entry */
        Pos=(Vaddr-RME_RV32GP_PGT_START(Meta->Base))>>RME_RV32GP_PGT_SIZEORD(Meta->Size_Num_Order);
        /* See if the entry is overrange */
        Num=RME_POW2(RME_RV32GP_PGT_NUMORD(Meta->Size_Num_Order));
        if(Pos>=Num)
            return RME_ERR_HAL_FAIL;
        ...
        if((Table[Pos]&RME_RV32GP_PGT_TERMINAL)!=0U)
        {
            /* This is a page - we found it */
            if(Pgt!=RME_NULL)
                *Pgt=(rme_ptr_t)Meta;
            if(Map_Vaddr!=RME_NULL)
                *Map_Vaddr=RME_RV32GP_PGT_START(Meta->Base)+(Pos<<RME_RV32GP_PGT_SIZEORD(Meta->Size_Num_Order));
            if(Paddr!=0U)
                *Paddr=RME_RV32GP_PGT_START(Meta->Base)+(Pos<<RME_RV32GP_PGT_SIZEORD(Meta->Size_Num_Order));
            if(Size_Order!=RME_NULL)
                *Size_Order=RME_RV32GP_PGT_SIZEORD(Meta->Size_Num_Order);
            if(Num_Order!=RME_NULL)
                *Num_Order=RME_RV32GP_PGT_NUMORD(Meta->Size_Num_Order);
            if(Flag!=RME_NULL)
        ...
        else
        {
            ...
            Meta=(struct __RME_RV32GP_Pgt_Meta*)RME_RV32GP_PGT_PGD_ADDR(Table[Pos]);
            Table=RME_RV32GP_PGT_TBL_NOM(Meta);
        }
    }
