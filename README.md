...
&ensp;&ensp;The final implementation is a set of mechanism that stays somewhere in the middle.
...
As [a](a) states, A VMM is only as useful as the operating system that it runs. By...

the key is lowering interaction frequency with the host system.
