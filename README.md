...
why thread migrating model
why thread migrating model with one-shot occupying (rather than a simple gate?)
why forcing a multi-threaded server is, great?

how to use async as sync if you don't want that, and why our async is reference counted?

how about IPIs?

### Virtualization

why HYP threads, and what is regset patching?
