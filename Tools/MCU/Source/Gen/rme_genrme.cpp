...
void RME_Gen::Include(std::unique_ptr<class Para>& Para)
{
    ...
    Para->Add("#include \"Platform/%s/rme_platform_%s.h\"",
              ...
              this->Main->Proj->Plat_Lower->c_str());
...
{
    /* RME directory */
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/Documents");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Include");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Include/Kernel");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Include/Platform");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Include/Platform/%s",this->Main->Proj->Plat_Name->c_str());
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Include/Platform/%s/Chips",this->Main->Proj->Plat_Name->c_str());
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Include/Platform/%s/Chips/%s",
                                this->Main->Proj->Plat_Name->c_str(),this->Main->Chip->Chip_Class->c_str());
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Kernel");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Platform");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/MEukaron/Platform/%s",this->Main->Proj->Plat_Name->c_str());
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/Project");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/Project/Source");
    this->Main->Dstfs->Make_Dir("M7M1_MuEukaron/Project/Include");
    
    /* Copy kernel file, kernel header, platform file, platform header, and chip headers */
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/Documents/EN_M7M1_Microkernel-RTOS-User-Manual.pdf");
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/Documents/CN_M7M1_Microkernel-RTOS-User-Manual.pdf");
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/MEukaron/Kernel/rme_kernel.c");
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/MEukaron/Include/rme.h");
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/MEukaron/Include/Kernel/rme_kernel.h");

    /* The toolchain specific assembly be created when we are playing with toolchains */
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/MEukaron/Platform/%s/rme_platform_%s.c",
                                 this->Main->Proj->Plat_Name->c_str(),this->Main->Proj->Plat_Lower->c_str());
    this->Main->Srcfs->Copy_File("M7M1_MuEukaron/MEukaron/Include/Platform/%s/rme_platform_%s.h",
                                 this->Main->Proj->Plat_Name->c_str(),this->Main->Proj->Plat_Lower->c_str());
}
/* End Function:RME_Gen::Folder **********************************************/
...
void RME_Gen::Conf_Hdr(void)
{
    ...
    File=this->Main->Dstfs->Open_File("M7M1_MuEukaron/MEukaron/Include/Platform/rme_platform.h");
    Doc->Write(File);
    fclose(File);

    Doc=std::make_unique<class Doc>();
    sprintf(Buf,"rme_platform_%s_conf.h", this->Main->Proj->Plat_Lower->c_str());
    Doc->Csrc_Desc(Buf, "The chip selection header.");
    Para=std::make_unique<class Para>("Doc:Platform Includes");
    Para->Add("/* Platform Includes *********************************************************/");
    Para->Add("#include \"Platform/%s/Chips/%s/rme_platform_%s.h\"",
              this->Main->Proj->Plat_Name->c_str(),
              this->Main->Proj->Chip_Class->c_str(),
              this->Main->Proj->Chip_Class->c_str());
    Para->Add("/* End Platform Includes *****************************************************/");
    Doc->Add(std::move(Para));
    Doc->Csrc_Foot();
    ...
    File=this->Main->Dstfs->Open_File("M7M1_MuEukaron/MEukaron/Include/Platform/%s/rme_platform_%s_conf.h",
                                      this->Main->Proj->Plat_Name->c_str(), this->Main->Proj->Plat_Lower->c_str());
    Doc->Write(File);
    fclose(File);
}
...
void RME_Gen::User_Src(void)
{
    ...
    /* Generate rme_user.c */
    File=this->Main->Dstfs->Open_File(std::make_unique<std::string>("M7M1_MuEukaron/Project/Source/rme_user.c"));
    Doc->Write(File);
    fclose(File);
}
