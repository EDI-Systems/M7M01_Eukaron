...
namespace rme_mcu
{
/* Begin Function:Proj_User::Read ********************************************
Description : Read the proj_user.c file, which contains all the user modifiable functions.
Input       : FILE* File - The file to read from.
Output      : None.
Return      : None.
******************************************************************************/
void Proj_User::Read(FILE* File)
{
    /* Currently left empty - should construct the rvm_user.c document tree */
}
/* End Function:Proj_User::Read **********************************************/
}
/* End Of File ***************************************************************/
