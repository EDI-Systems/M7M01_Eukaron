...
|RME_SVC_CPT_CRT     |9     |创建一个权能表                                                       |
|RME_SVC_CPT_DEL     |10    |删除一个权能表                                                       |
|RME_SVC_CPT_FRZ     |11    |冻结权能表内的某权能                                                  |
|RME_SVC_CPT_ADD     |12    |进行权能传递                                                        |
|RME_SVC_CPT_REM     |13    |移除权能表内的某权能                                                  |
|RME_SVC_PGT_CRT      |14    |创建一个页目录                                                      |
|RME_SVC_PGT_DEL      |15    |删除一个页目录                                                      |
|RME_SVC_PGT_ADD      |16    |添加一个页表项                                                      |
|RME_SVC_PGT_REM      |17    |移除一个页表项                                                      |
|RME_SVC_PGT_CON      |18    |构造页表                                                           |
|RME_SVC_PGT_DES      |19    |析构页表                                                           |
|RME_SVC_PRC_CRT       |20    |创建一个进程                                                        |
|RME_SVC_PRC_DEL       |21    |删除一个进程                                                        |
|RME_SVC_PRC_CPT       |22    |替换进程的权能表                                                     |
|RME_SVC_PRC_PGT       |23    |替换进程的页表                                                      |
