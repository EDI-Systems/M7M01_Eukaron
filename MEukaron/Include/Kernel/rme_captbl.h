...
/* Defines *******************************************************************/
#ifdef __HDR_DEFS__
#ifndef __RME_CAPTBL_H_DEFS__
#define __RME_CAPTBL_H_DEFS__
/*****************************************************************************/
...
#define RME_CAP_FROZEN              (((rme_ptr_t)1)<<((sizeof(rme_ptr_t)*6)-1))
 ...
 */
#define RME_CAP_REF_MASK           (RME_MASK_END((sizeof(rme_ptr_t)*6)-2))
#define RME_CAP_MAXREF             (RME_CAP_REF_MASK>>1)
#define RME_CAP_TYPEREF(TYPE,REF)  ((((rme_ptr_t)(TYPE))<<(sizeof(rme_ptr_t)*6))|(REF))
...
#ifndef __RME_CAPTBL_H_STRUCTS__
#define __RME_CAPTBL_H_STRUCTS__
...
#ifndef __RME_CAPTBL_MEMBERS__
#define __RME_CAPTBL_MEMBERS__
...
__EXTERN__ rme_ret_t _RME_Captbl_Rem(struct RME_Cap_Captbl* Captbl, rme_cid_t Cap_Captbl_Rem, rme_cid_t Cap_Rem);
/*****************************************************************************/
/* Undefine "__EXTERN__" to avoid redefinition */
#undef __EXTERN__
/* __RME_CAPTBL_MEMBERS__ */
#endif
